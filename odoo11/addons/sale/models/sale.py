...
class SaleOrderLine(models.Model):
    ...
    product_uom_2 = fields.Char(string='Unit of Measure(Printed)', help="Customer facing unit of measure", required=False)
    ...
    def update_uom_2(self):
        self.product_uom_2 = self.product_uom.name
